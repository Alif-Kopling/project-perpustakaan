...
@section('page-title', 'Import Data Buku dari CSV')

@section('content')
<div class="card p-6 max-w-2xl mx-auto">
    <form action="{{ route('admin.import.books.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            <strong>Format file:</strong> judul,penulis,penerbit,stok<br>
